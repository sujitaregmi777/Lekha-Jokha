...
import { Moon ,Sun,Menu, MessageCircleMore, Bell ,Bot } from "lucide-react";
    ...
    return(
        <>
            <div className="p-4 border-2 flex gap-6 items-center justify-between">  
                <button onClick={togglesidebar}  className="bg-white text-purple-700 hover:text-purple-950 ">< Menu size = { 20 }/></button>
                <div className="flex gap-6 justify-center items-center">
                    {/* <Link to = "/" className = "flex items-center gap-2">< Home size = { 20 }/> Home</Link> */}
                </div>
        <div className="flex gap-4 items-center">
                <button onClick={togglemessage}  className="bg-white text-purple-700   hover:text-black ">< MessageCircleMore size = { 20 }/></button>
                ...
                <button onClick={toggleai}   className=" fixed bottom-6 right-6  bg-purple-600  text-white p-3 rounded-full shadow-xl z-50 hover:bg-purple-700"> <Bot size={20}/> </button>
