...
import { LayoutDashboard, BadgeDollarSign, ClipboardMinus, Settings, CalendarCheck, BanknoteArrowDown, X , UsersRound, UserRound, LogOut } from 'lucide-react';
...
export default function Sidebar( { open , onclose }){
    ...
    return(
        ...
        <div  className="p-4 flex  flex-col gap-7 pt-20 justify-between" >
            ...
            <Link to = "/settlement" className="text-xl font-bold flex items-center gap-2 hover:underline hover:text-blue-500" >< ClipboardMinus size = { 25 } />Settlement</Link>  
            ...
            <div className="mt-48  bg-slate-500 p-5 ">
                <Link to = "/login" className="text-xl font-bold flex gap-2 bg- hover:underline hover:text-blue-500 " >< LogOut size = { 25 } />LogOut</Link>  
